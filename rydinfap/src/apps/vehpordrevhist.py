...
class VehPORevHist(_InfaBaseApp):  
    exitOnError = True
    
    def __init__(self):
        super(VehPORevHist,self).__init__()
        ...
        self.RowCnt     = -1
        self.srcFile    = ('PO880d30.dat')   # File that Informatica expects. Alphabetical.
        self.ib.fileName = r"'P.PO880D30.WHOUSE.HIST.STD'"
...
#        return self.cpSrcToTgtFiles()
    ...
    def procVehPORevHistDly(self):
        ...
        if self.checkRowCntFlg is True:
             pass
 
        # Run workflows
        if self._wkfVehPORevHistDly()    != 0 : return 1
