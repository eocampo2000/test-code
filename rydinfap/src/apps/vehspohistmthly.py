...
class VehSPOHistMthly(_InfaBaseApp):  
    exitOnError = True
    ...
    def getFtpFiles(self):
        return ft.getn('VehSPOHist',self.log)
    ...
    def _wkfSPOHistMthly(self):
        self.ib.fld     = 'Vehicle'
        self.ib.wkf     = 'wkf_veh_spo_history_monthly'   
    ...
    def procSPOHist(self):
        ...
        # Run workflows
        if self._wkfSPOHistMthly()      != 0 : return 1
