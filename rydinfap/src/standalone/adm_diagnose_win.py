...
#os.environ['CONFIG_FILE']       =  r'c:/apps/canNetezzaProd.cfg' 
#os.environ['CONFIG_FILE']       =  r'c:/apps/canOraInfaProd.cfg'
os.environ['CONFIG_FILE']       =  r'c:/apps/canInfaProd.cfg'
...
ib            = PlaceHolderBean()
ib.host       = 'sscldinf'         # PingServer, DiskUsage, PDom,PIS ,ConRep
#ib.dbType    = 'NZODDB'           # PingDB, connToDB
ib.dom_host   = 'sscldinf'
ib.dom_name   = 'Domain_Dev'       # PDom,PIS ,ConRep
ib.dom_node   = 'node01_sscldinf'  # PDom
ib.dom_port   = 6005               # PDom,PIS
ib.IS         = 'IS_Development'   # PIS
ib.rep_name   = 'Development'      # ConRep
ib.rep_user   = 'eocampo'          # ConRep
ib.rep_pwd    = 'oceandev'         # ConRep
#
#
## Netezza
##ib.dbType     = 'NZODDB'
##ib.db_server  = "RSNETEZZAP03"
##ib.db_name    = "EDW"
##ib.db_user    = "admin"
###ib.db_pwd       = "nz@dmin00"
##ib.db_pwd     = "skimmer2010"
#
## Oracle
#ib.dbType     = 'ORADB'
#ib.db_server  = 'SSCLTORA'
#ib.db_name    = "infadev" # Service
#ib.db_user    = 'infadev'
#ib.db_pwd     = 'infadev'

#ib.rep_dbuser = 'infadev'
#ib.rep_dbpwd  = 'infadev'
#ib.rep_dbname = 'infadev'
#
